...
#define ACKSIZE 7
#define MAXIMUM_SEGMENT_SIZE 1030 //BUFFERSIZE + ACKSIZE
...
int main(int argc, char *argv[]){
    ...
    int ack_received;
    int b_fread;
    int number_of_fragment = sizeFile(filename)/MAXIMUM_SEGMENT_SIZE +1;
    ...
    pkt* sequence=malloc(sizeof(struct pacquet)*1024);
